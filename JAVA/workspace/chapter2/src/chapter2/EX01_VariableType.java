...
public class EX01_VariableType {
	...
	public static void main(String[] args) {
		...
		// long 자료형의 경우 마지막에 영어 L을 붙여야 에러가 발생하지 않음
		long l = 9223372036854775807L;
		// byte, short 거의 쓰이지 않고 기본은 int로 사용하고
		// 너무 큰 값을 저장하는 경우에는 long을 사용해야함
		
		// 문자 자료형
		// char : 한글자만 저장할 수 있는 자료형
		char c = 'A';
		System.out.println(c);
		c = 65; // 아스키코드 or 유니코드로 저장 가능
		System.out.println(c);
		// String : 여러 글자(문자열)를 저장할 수 있는 자료형, 큰 따움표로 감싸서 사용
		// 첫글자가 대문자인 이유 : 위에서 사용한 소문자 자료형들은 기본자료형
		// 첫글자가 대문자인 경우에는 클래스 자료형이라고 함
		String str = "안녕하세요";
		...
		// 실수 자료형
		// float : 소수점을 저장하는 자료형 (메모리가 작음)
		float f = 3.14F; // 소수점 아래 7자리까지
		// double : float에 두배 (메모리가 큼)
