...
//	클래스 변수(멤버 변수) : 클래스 이름 아래(안에)에 작성하는 static 변수
	static int StaticA = 10;
//	인스턴스 변수(멤버 변수) : 클래스 이름 아래(안에)에 작성하는 변수
	int a = 0;
//	지역 변수(로컬 변수) : 메서드 이름 아래(안에)에 작성하는 변수
//	매개 변수(파라미터) : 메서드 선언부, 메서드의 이름 뒤에 괄호에 적는 변수
